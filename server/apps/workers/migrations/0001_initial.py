        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'middle_name',
                    models.CharField(
                        blank=True, max_length=100, verbose_name='Moddle name'
                    ),
                ),
                (
                    'last_name',
                ...
                (
                    'hired_date',
                    models.DateField(
                        auto_now_add=True, verbose_name='Date of employment'
                    ),
                ),
                (
                    'deleted_at',
            ...
            options={
                ...
                'indexes': [
                    models.Index(
                        fields=['position'],
                        name='workers_wor_positio_86a69d_idx',
                    ),
                    models.Index(
                        fields=['is_active'],
                        name='workers_wor_is_acti_bfc83b_idx',
                    ),
                ],
                'constraints': [
                    models.CheckConstraint(
                        ...
                        name='workers_worker_position_valid',
                    )
                ],
            },
        ),
